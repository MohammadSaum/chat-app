  ...
  return (
    <div className='flex flex-col shrink-0 overflow-auto  h-screen w-md text-white font-semibold text-xl p-5 pb-0'>
        ...
        <div className=' mt-3 w-full'>
          ...
          <div
            className="relative group w-27 h-27 rounded-full flex items-center justify-center"
            role="button"
            aria-label="Change profile photo"
          >
            {/* svg uses fill=currentColor so color is controlled by parent text color */}
            <div className="text-[#FFFFFF99] group-hover:text-white transition-colors duration-200">
              <svg
                className="w-24 h-24"
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-black/40 text-white text-sm rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
            ...
            <div className=' p-3 font-normal'>
                ...
                className="text-[#FFFFFF99] hover:text-white transition-colors duration-150 rounded-full"
            >
                <svg
                    className="w-6 h-6"
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className=' p-3 font-normal'>
                ...
                <div className=" text-[#FAFAFA] flex justify-between font-medium text-base">
                    ...
                    <button 
                        ...
                        className="text-[#FFFFFF99] hover:text-white transition-colors duration-150 rounded-full"
                        >
                        <svg className='cursor-pointer active:scale-95 duration-150'
            ...
            <div className=' p-3 font-normal'>
                ...
                <div className=" text-[#FAFAFA] flex justify-between font-medium text-base">
                    ...
                    <button title="Copy">
                        <svg className="cursor-pointer active:scale-95 duration-150 rounded-full" 
