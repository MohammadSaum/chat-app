...
const StatusPage = () => {
  return (
    <div className=' w-md h-screen pt-5 px-5 pb-0 shrink-0 overflow-auto flex flex-col '>
        ...
        <div className='h-full -mx-2 minScrollBar overflow-y-auto relative'>
            ...
            <div className='text-[#FFFFFF99] text-sm font-medium py-5 px-3'>
                    Recent 
                </div>
            <div className=' flex justify-around text-[#FFFFFF99] text-sm font-medium px-3'>No recent updates</div>

            

            <div className='text-[#FFFFFF99] gap-1 text-xs font-medium flex justify-center items-center px-5 py-5 pb-10 absolute bottom-0 w-full'>
